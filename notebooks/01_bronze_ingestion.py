...
# Data is loaded into csj_bronze.raw_funding by Airflow via the SQL Statement API.
# Run this notebook manually to inspect the bronze table.

# COMMAND ----------

# Check row count and schema
df = spark.table("csj_bronze.raw_funding")
...
# Preview data
display(spark.table("csj_bronze.raw_funding").limit(10))

# COMMAND ----------

# Check ingestion timestamps — when was data last loaded?
from pyspark.sql import functions as F
spark.table("csj_bronze.raw_funding") \
    .select(
